...
export default function ProjectsPage() {
  return (
    <>
      <div className="pt-[160px] pb-[120px] max-w-[1360px] mx-auto px-[80px]">
        ...
        <ScrollReveal delayClass="d1" className="font-display text-[clamp(42px,5vw,72px)] font-extrabold leading-[1.04] tracking-[-.035em] mt-[8px] mb-[72px] max-w-[680px]">
          Systems engineered.<br />Problems eliminated.
        </ScrollReveal>
        
        <div className="grid grid-cols-[1fr_1fr] gap-[24px]">
          {/* Featured Project */}
          <ScrollReveal className="bg-(--bg-2) border border-(--border) rounded-[12px] p-[48px] relative overflow-hidden flex flex-row items-center justify-between transition-colors duration-200 hover:border-(--border-md) hover:bg-(--bg-3) group col-[1/-1]">
            <div>
              <div className="font-mono text-[11px] font-medium tracking-[.08em] uppercase text-(--text-3) mb-[12px]">
                ● Infrastructure · 2024
              </div>
              <h3 className="font-display text-[28px] font-bold tracking-[-.015em] mb-[16px]">
            ...
            <div className="w-[320px] h-[180px] bg-(--bg-1) border border-(--border) rounded-[8px] flex items-center justify-center relative shrink-0">
            ...
            <div className="absolute top-[24px] right-[24px] text-[18px] text-(--text-3) transition-all duration-200 group-hover:text-(--amber) group-hover:translate-x-[3px] group-hover:-translate-y-[3px]">↗</div>
          </ScrollReveal>

          {/* Project 2 */}
          <ScrollReveal delayClass="d1" className="bg-(--bg-2) border border-(--border) rounded-[12px] p-[32px] relative overflow-hidden flex flex-col justify-between transition-colors duration-200 hover:border-(--border-md) hover:bg-(--bg-3) group">
            <div>
              <div className="font-mono text-[11px] font-medium tracking-[.08em] uppercase text-(--text-3) mb-[12px]">
                ● AI Systems · 2024
              </div>
          ...
          {/* Project 3 */}
          <ScrollReveal delayClass="d2" className="bg-(--bg-2) border border-(--border) rounded-[12px] p-[32px] relative overflow-hidden flex flex-col justify-between transition-colors duration-200 hover:border-(--border-md) hover:bg-(--bg-3) group">
            <div>
              <div className="font-mono text-[11px] font-medium tracking-[.08em] uppercase text-(--text-3) mb-[12px]">
                ● Architecture · 2023
              </div>
          ...
          {/* Project 4 */}
          <ScrollReveal className="bg-(--bg-2) border border-(--border) rounded-[12px] p-[32px] relative overflow-hidden flex flex-col justify-between transition-colors duration-200 hover:border-(--border-md) hover:bg-(--bg-3) group">
            <div>
              <div className="font-mono text-[11px] font-medium tracking-[.08em] uppercase text-(--text-3) mb-[12px]">
                ● Ecosystems · 2023
              </div>
