    ...
    <section className="max-w-6xl mx-auto px-6 py-24">
      ...
      <div className="grid md:grid-cols-2 gap-8 mt-16">
        ...
        <TeamCard
          ...
          responsibilities="Leads all technical decisions, system architecture, and engineering standards. Responsible for technology strategy, scalability, performance, and ensuring technical excellence across all projects."
          skills={[
            "System Design",
            "Backend Engineering",
            "Technology Strategy",
