  ...
  return (
    <>
      <div className="pt-32 md:pt-[160px] pb-16 md:pb-[100px] max-w-[1360px] mx-auto px-6 md:px-[80px]">
        ...
        <ScrollReveal delayClass="d1" className="font-display text-4xl sm:text-5xl md:text-[clamp(42px,5vw,72px)] font-extrabold leading-[1.04] tracking-[-.035em] mt-[8px] mb-10 md:mb-[60px] max-w-[720px]">
          We are not building apps.<br />We are engineering the future.
        </ScrollReveal>
        
        <div className="grid md:grid-cols-[1fr_1fr] gap-12 md:gap-[80px]">
          <div>
            ...
            <ScrollReveal delayClass="d1" className="text-[15px] md:text-[16px] text-(--text-2) leading-[1.72] mb-[20px]">
            ...
            <ScrollReveal delayClass="d2" className="text-[15px] md:text-[16px] text-(--text-2) leading-[1.72] mb-[20px]">
            ...
            <ScrollReveal delayClass="d3" className="text-[15px] md:text-[16px] text-(--text-2) leading-[1.72] mb-[32px]">
      ...
      {/* PHILOSOPHY */}
      <div className="bg-(--bg-2) border-y border-(--border) mt-[40px] md:mt-[60px]">
        <div className="max-w-[1360px] mx-auto px-6 md:px-[80px] py-16 md:py-[100px]">
          <div className="grid lg:grid-cols-[1fr_450px] gap-12 md:gap-[80px] items-center">
            <div>
              ...
              <ScrollReveal delayClass="d1" className="font-display text-3xl sm:text-4xl md:text-[52px] font-extrabold leading-[1.05] tracking-[-.02em] mb-[24px] md:mb-[32px]">
                Making complex systems<br className="hidden sm:block"/>
                <span className="text-(--amber)">simpler, smarter,</span><br className="hidden sm:block"/>
                and connected.
              </ScrollReveal>
              
              <div className="max-w-[640px]">
                <ScrollReveal delayClass="d2" className="text-[15px] md:text-[18px] text-(--text-2) leading-[1.72] mb-[24px]">
                ...
                <ScrollReveal delayClass="d3" className="text-[15px] md:text-[18px] text-(--text-2) leading-[1.72]">
            ...
            <ScrollReveal delayClass="d4" className="relative group lg:block">
              ...
              <div className="relative aspect-4/5 rounded-[24px] overflow-hidden border border-white/10 shadow-2xl">
                ...
                <div className="absolute bottom-6 md:bottom-8 left-6 md:left-8 right-6 md:right-8 p-6 backdrop-blur-md bg-white/5 border border-white/10 rounded-[16px]">
      ...
      <div className="max-w-[1360px] mx-auto px-6 md:px-[80px] py-16 md:py-[120px]">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-[80px] gap-4 md:gap-8">
          ...
          <ScrollReveal delayClass="d2" className="text-[14px] text-(--text-3) max-w-[320px] md:text-right leading-relaxed mt-4 md:mt-0">
      ...
      <div className="max-w-[1360px] mx-auto px-4 sm:px-6 md:px-[80px] pb-16 md:pb-[120px]">
        <ScrollReveal className="bg-(--bg-2) border border-(--border) rounded-[24px] p-8 sm:p-12 md:p-[64px] text-center relative overflow-hidden">
          ...
          <h2 className="font-display text-3xl sm:text-4xl md:text-[44px] font-bold leading-[1.05] tracking-[-.025em] mb-[20px]">
            Ready to engineer<br/>something real?
          </h2>
          <p className="text-[15px] md:text-[16px] text-(--text-2) leading-[1.72] max-w-[500px] mx-auto mb-[36px]">
