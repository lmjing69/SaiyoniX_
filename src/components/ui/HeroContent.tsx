...
export default function HeroContent() {
    return (
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center w-full min-h-[100vh]">
            {/* Left: Text Content */}
            ...
            <div className="hidden lg:flex items-center justify-center pt-24 lg:pt-0">
                <div className="relative w-full max-w-md aspect-square">
                    ...
                    <motion.div
                        ...
                        className="relative w-full h-full rounded-[2rem] bg-white border border-slate-200 shadow-2xl shadow-slate-200/60 overflow-hidden"
                    >
                        {/* Inner frame */}
                        <div className="absolute inset-6 rounded-2xl border border-slate-200/60 bg-gradient-to-br from-slate-100/50 to-transparent" />
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            ...
                            <div className="relative w-14 h-14">
                                ...
                                />
                                <div className="absolute inset-4 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 shadow-inner shadow-blue-200/50" />
                            </div>
